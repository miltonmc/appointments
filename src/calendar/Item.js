...
export default class Item extends Component {
  ...
  handleSubmit = () => {
    const { startDate, startTime, endDate, endTime, customer, notes, healthPlanId } = this.state;
          ...
          <Form onSubmit={this.handleSubmit} error={!!errorMessage} size="mini">
            <Form.Group>
              <Form.Input
                ...
                required
              />
              <Form.Input type="time" name="startTime" value={startTime} onChange={this.handleChange} required />
              <div className="calendar__new-item">até</div>
              <Form.Input width={7} type="date" name="endDate" value={endDate} required onChange={this.handleChange} />
              <Form.Input type="time" name="endTime" value={endTime} onChange={this.handleChange} required />
            </Form.Group>
            <CustomerField selectedCustomer={customer} onChange={this.handleChange} />
            <HealthPlanField
              ...
              onChange={this.handleChange}
            />
            <Form.TextArea label="Notas" rows="3" name="notes" value={notes} onChange={this.handleChange} />
